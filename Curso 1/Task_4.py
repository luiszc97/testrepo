...
def login(user_accounts, log_in, username, password):
    ...
    # your code here
    if username not in user_accounts or password not in user_accounts[username]:
        return False
    else:
        user_accounts[username] = password
...
def change_password(user_accounts, log_in, username, old_password, new_password):
    ...
    # your code here
    if username not in user_accounts or log_in[username] == False:
        return False

    if old_password != user_accounts[username]:
        return False

    if new_password == user_accounts[username]:
        return False
